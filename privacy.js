export const privacy = () => {
    ...
    <body>
        ...
        <div style="margin-top: 24px; margin-bottom: 24px; text-align: left;">
            <p style="font-weight: 500; color: #757575;">
            ...
            <div>
                ...
                <ul style="padding-left: 24px; margin-top: 16px;">
            ...
            <div>
                ...
                <p>
                    ...
                    <a href="mailto:privacy@tkurbx.com" style="color: #64B5F6; text-decoration: underline;">
                        privacy@tkurbx.com
                    </a>.
                </p>
            </div>
